            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="task">
                        ...
                        <div class="form-group">
                            <label for="trank" class="control-label">Rank:</label>
                            <input id="trank" class="form-control" type="text">
                        </div>
                        <div class="form-group">
                            <label for="tnotes" class="control-label">Notes:</label>
                            <textarea class="form-control" id="tnotes"></textarea>
                        </div>
                        {!! csrf_field() !!}
                    </form>
                </div>
